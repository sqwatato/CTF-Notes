https://play.picoctf.org/practice/challenge/307?page=9
```
...
- since it is a substitution cipher, I try going to https://www.dcode.fr/monoalphabetic-substitution for a monoalphabetic [[Substitution ciphers]]
- lucky for me it gave me the flag